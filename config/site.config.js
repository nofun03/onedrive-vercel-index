...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'oribaba01@bntechauto.info',
  ...
  title: "Noor's Tutorial Collection",
  ...
  email: 'mailto:fuckpia@bntechauto.info',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/nofun03/onedrive-vercel-index',
    },
  ],
